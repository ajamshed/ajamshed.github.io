...
\begin{innerlist}
\item {Software Development Engineer II: Building Elastic Network Interface (ENI) features for Nitro-based droplets. Developing next generation VPC tools for network monitoring \& diagnostics. Also closely collaborating with reliability engineering team on CI/CD pipeline tasks. } \\
\end{innerlist}
