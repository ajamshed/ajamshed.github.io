...
KAIST       & \textit{WWW:}
\href{http://www.something.com/}{www.something.com}\\
Addr 1, Daejeon 34141 \\
Republic of Korea    
\end{tabular}
...
\section{Education}
%
\href{http://www.kaist.ac.kr}{\textbf{Korea Advanced Institute of Science \& Technology}}, Daejeon, Republic of Korea
\begin{outerlist}
...
\item[] BSc (Hons), 
        \href{http://cs.lums.edu.pk/}
             {Computer Science}, (Sept '01-May '05)
        \begin{innerlist}
...
(i) Human Detection in the Internet: See [2] and the Projects section for more details.} \\
...
\textit{Graduate Researcher \\
(i) Email Spam Behavior - Detection \& Prevention: Analyzed email spamming behaviors after 
installing honeypots in open-proxy settings.  \\
(ii) Human Detection in the Internet: See [2] and the Projects section for more details.} \\
...
\textit{Graduate Researcher - Worked on a framework to mitigate the effects 
			of application-level DDoS attacks [1,3]. See Projects section for 
more details.} \\

\section{Publications}
[1] Jamshed, M., Brustoloni, J. ``In-Network Server-Directed Client Authentication 
		and Packet Classification." (in submission) \\
...
\section{Relevant Coursework (Graduate)}
%
...
\begin{outerlist}
\item[] {DDoS attacks increasingly use normal-looking application-layer requests to waste HTTP server CPU or disk resources. CAPTCHAs attempt to distinguish bots from human clients and are often used to avoid such attacks. However, CAPTCHAs themselves consume resources and frequently are defeated. I developed Bobuster, an extensible ebtables module that pushes client authentication in the kernel while overcoming several limitations in Kill-Bots (NSDI '05). It can easily be deployed as a bridge in front of server farms, modularly accepts a variety of present and future authentication schemes, and can do server-directed client authentication and packet classification. This work was extended as Sentinel and appeared at ICCCN '08 and another that has been submitted to a conference.}
\end{outerlist}
