...
\makeheading{M{\footnotesize UHAMMAD} A{\footnotesize SIM} J{\footnotesize AMSHED}, Ph.D.} & \hspace{0.75in}{\it Last Updated: 09/18/2019}
\end{tabular}
...
\textbf{Intel Labs} \hfill \textbf{May 2017-onwards} \\
\textit{Research Scientist, {\small Telco Systems Research Group} \\
(i) High performance networked systems: See [1] in Projects section for details.} \\

\textbf{Networked \& Distributed Computing Systems Lab}  
				\hfill \textbf{Fall '10-Spring '17} \\
\textit{Graduate Researcher, {\small EE Dept., KAIST} \\
(i) Smart resource management in heterogeneous systems: See [5] in Projects section for details. \\
(ii) High performance networked systems: See [2, 4] in Projects section for details. \\
(iii) Highly scalable intrusion detection systems: See [5] in Projects section for details. \\
(iv) Human (\& spam) detection in the Internet: See [6] in Projects section for details.} \\
...
(ii) Human detection in the Internet: See [6] in Projects section for details.} \\

\textbf{Network Systems Lab} 
				\hfill \textbf{Summers '07 $\&$ '08} \\
\textit{Graduate Researcher,  {\small CS Dept., Univ of Pittsburgh} \\
 Defense against application-level DDoS attacks: See [7] in Projects section for details.} \\
...
[14] {\bf Jamshed, M.}, Brustoloni, J. ``In-Network Server-Directed Client Authentication 
...
%
{\textbf{Intel Labs, Hillsboro, OR}} 
			\hfill {May 2017-onwards}
\begin{innerlist}
\item {Research Scientist, Telco Systems Research Group: Maintaining OMEC's ngic-rtc. See
