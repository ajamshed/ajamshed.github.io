...
\makeheading{M{\footnotesize UHAMMAD} A{\footnotesize SIM} J{\footnotesize AMSHED}} & \hspace{0.75in}{\it Last Updated: 03/13/2022}
\end{tabular}
...
2121 8th Ave, Seattle, WA 98121    & \textit{WWW:}
...
\begin{innerlist}
\item {PhD, {Electrical Engineering} (Spring '17). Advisor -- Prof. KyoungSoo Park}
\end{innerlist}

{\textbf{University of Pittsburgh}}, Pittsburgh, Pennsylvania, USA
\begin{innerlist}
\item {MS, {Computer Science} (Apr '10). Advisors -- Prof. KyoungSoo Park \& Prof. Daniel Moss\'e}
\end{innerlist}

{\textbf{Lahore University of Management Sciences}}, Pakistan
\begin{innerlist}
\item {BSc (Hons), {Computer Science}, (May '05).}
...
\begin{innerlist}
\item {SDE II, EC2 VPC (Aug '20-onwards). Reporting to Mustafa Arisoylu (SDM)}
\end{innerlist}

{\textbf{Intel Labs, Intel Jones Farm 2 (JF2)}, Hillsboro, OR}
\begin{innerlist}
\item {Research Scientist, Telco Systems (May '17-Aug '20). Reporting to Christian Maciocco(Sr Principal Engineer)}
\end{innerlist}

{\textbf{International Computer Science Institute (ICSI)}, Berkeley, CA} 
\begin{innerlist}
\item {Research Intern (May '14-Aug '14, Oct '15-Dec '15). Mentor -- Dr. Robin Sommer}
%\item {Developed Packet Bricks. See [3] in Projects section.}
\end{innerlist}

{\textbf{Palmchip Corporation}, Lahore, Pakistan}
\begin{innerlist}
\item {Software Engineer (May '05-July '06). Reporting to Ahrar Naqvi (VP Engineering)}
...
{\textbf{1. A{\footnotesize ETHER} P{\footnotesize ROJECT}}} (\href{https://github.com/omec-project/upf}{\texttt{https://github.com/omec-project/upf}})
\begin{innerlist}
\item {4G/5G Control User Plane Separated (CUPS) {\texttt TS23501} based packet core controlled by PFCP}
\item {\textit{URL:} \href{https://opennetworking.org/aether/}{\texttt{https://opennetworking.org/aether/}}}
\end{innerlist}
...
\section{Awards}
%
ONF OMEC/COMAC Community Award, \& Intel Division Recognition Award for Aether \& OMEC \\
...
Graduate Fellowship Spring 2006, \& Undergraduate Dean's Honor List 2001-03
