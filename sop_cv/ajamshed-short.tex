...
\makeheading{M{\footnotesize UHAMMAD} A{\footnotesize SIM} J{\footnotesize AMSHED}} & \hspace{0.75in}{\it Last Updated: 08/07/2021}
\end{tabular}
...
\begin{innerlist}
\item {SDE II, EC2 VPC (Aug '20-onwards). Reporting to Padmanaban Balasubramaniam (SDM)}
\end{innerlist}

{\textbf{Intel Labs, Intel Jones Farm 2 (JF2)}, Hillsboro, OR}
\begin{innerlist}
\item {Research Scientist, Telco Systems (May '17-Aug '20). Reporting to Christian Maciocco (Principal Engineer)}
\end{innerlist}
...
\section{Awards}
%
ONF OMEC/COMAC Community Award, \& Intel Division Recognition Award for OMEC \\
